						...
						<tbody>
							<?php
								if(isset($_GET['keyword'])){
									...
									$sqlsearch = "SELECT * FROM user WHERE role='user' AND (fname LIKE '%$keyword%' OR lname LIKE '%$keyword%' OR email LIKE '%$keyword%' OR address LIKE '%$keyword%')";
									...
									if ($num_searchrows == 0){
										...
										$id = $searchrecord['userid'];

										echo "<tr>";
										echo "<td><img src='" . $searchrecord['profile'] . "' width='50' height='50'></td>";
										echo "<td>" . $searchrecord['fname'] . " " . $searchrecord['lname'] . "</td>";
										echo "<td>" . $searchrecord['email'] . "</td>";
										echo "<td>" . $searchrecord['address'] . "</td>";
										echo "<td><a href='#' onclick='showConfirm(" . $id . ")'>Delete</a> || <a href='edituser.php?id=" . $id . "'>Edit</a></td>";
										echo "</tr>";
									}
								}
								else{
									...
									if($num_rows == 0){
										...
										for($i = 0; $i < $num_rows; $i++) {
											...
											echo "<tr>";
											echo "<td><img src='" . $record['profile'] . "' width='50' height='50'></td>";
